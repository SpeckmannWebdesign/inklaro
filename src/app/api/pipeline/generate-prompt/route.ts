...
export async function POST(request: Request) {
  ...
  try {
    ...
    const pencilInput = mapAnfrageToPencilInput({
      ...
      erfahrung: anfrage.erfahrung || undefined,
      teamgroesse: anfrage.teamgroesse || undefined,
      leistungen: anfrage.leistungen || undefined,
      usp: anfrage.usp || undefined,
      slogan: anfrage.slogan || undefined,
      ...
      tonalitaet: anfrage.tonalitaet || undefined,
      gewuenschteCta: anfrage.gewuenschteCta || [],
      ...
      eigeneFotos: anfrage.eigeneFotos || undefined,
      seiten: anfrage.seiten,
      texteVorhanden: anfrage.texteVorhanden,
      sonstiges: anfrage.sonstiges || undefined,
      socialMedia: anfrage.socialMedia || undefined,
      oeffnungszeiten: anfrage.oeffnungszeiten || undefined,
