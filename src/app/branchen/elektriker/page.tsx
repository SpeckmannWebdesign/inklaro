  ...
  return (
    <BranchenShowcase
      ...
      faqs={[
        ...
        { frage: "Kann ich meine Leistungen selbst ändern?", antwort: "Ja — Textänderungen, neue Fotos oder zusätzliche Leistungen kannst du jederzeit bei uns beauftragen. Das ist im monatlichen Paket (39 €/Monat) bereits enthalten." },
