...
export default function FitnessstudioPage() {
  return (
    <BranchenShowcase
      ...
      vorteile={[
        { titel: "Kursplan übersichtlich dargestellt", text: "Ihre Mitglieder und Interessenten sehen auf einen Blick, welche Kurse wann stattfinden — aktuell, übersichtlich und auf dem Smartphone abrufbar." },
        ...
        { titel: "Ausstattung und Angebot zeigen", text: "Trainingsgeräte, Wellness-Bereich, Personal Training — zeigen Sie, was Ihr Studio besonders macht. Bilder und kurze Beschreibungen wirken stärker als lange Texte." },
      ...
      faqs={[
        { frage: "Kann ich meinen Kursplan regelmäßig aktualisieren lassen?", antwort: "Ja, Änderungen am Kursplan oder an Öffnungszeiten können Sie jederzeit bei uns beauftragen. Das ist im monatlichen Paket (79 €/Monat) inklusive." },
        { frage: "Kann ich ein Probetraining-Formular einbinden?", antwort: "Ja, wir integrieren ein Anmeldeformular für Probetrainings, das direkt auf Ihrer Startseite oder einer separaten Landingpage platziert wird." },
        ...
        { frage: "Wie schnell ist meine Fitness-Website online?", antwort: "In der Regel stellen wir Ihnen die fertige Website innerhalb von 1–2 Werktagen vor. Nach Ihrer Freigabe ist sie sofort live." },
      ]}
    />
  );
}
