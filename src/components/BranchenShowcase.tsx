...
const alleBranchen = [
  { name: "Restaurant", desc: "Gastronomie, Catering, Bistro", img: "/images/card-restaurant.avif", href: "/branchen/restaurant" },
  { name: "Café", desc: "Café, Bäckerei, Bistro", img: "/images/card-cafe.avif", href: "/branchen/cafe" },
  { name: "Fitnessstudio", desc: "Gym, Personal Training, Fitness", img: "/images/card-fitnessstudio.avif", href: "/branchen/fitnessstudio" },
  { name: "Yogastudio", desc: "Yoga, Pilates, Meditation", img: "/images/card-yoga.avif", href: "/branchen/yoga" },
  { name: "Physiotherapie", desc: "Praxis, Therapie, Reha", img: "/images/card-physiotherapie.avif", href: "/branchen/physiotherapie" },
  { name: "Zahnarzt", desc: "Praxis, Implantate, Prophylaxe", img: "/images/card-zahnarzt.avif", href: "/branchen/zahnarzt" },
  { name: "Arztpraxis", desc: "Hausarzt, Facharzt, Therapeut", img: "/images/Tfgar.avif", href: "/branchen/arztpraxis" },
  { name: "Rechtsanwalt", desc: "Kanzlei, Anwalt, Notar", img: "/images/card-rechtsanwalt.avif", href: "/branchen/rechtsanwalt" },
  { name: "Steuerberater", desc: "Buchhaltung, Steuern, Beratung", img: "/images/card-steuerberater.avif", href: "/branchen/steuerberater" },
  { name: "Architekt", desc: "Planung, Bauleitung, Entwurf", img: "/images/card-architekt.avif", href: "/branchen/architekt" },
  { name: "Coaching", desc: "Business-, Life- & Personal Coach", img: "/images/card-coaching.avif", href: "/branchen/coaching" },
  { name: "Fotograf", desc: "Hochzeit, Portrait, Business", img: "/images/card-fotograf.avif", href: "/branchen/fotograf" },
  { name: "Hochzeitsplanung", desc: "Hochzeitsplaner, Events", img: "/images/card-hochzeitsplanung.avif", href: "/branchen/hochzeitsplanung" },
  { name: "Tischler", desc: "Tischlerei, Schreiner, Möbelbau", img: "/images/card-tischler.avif", href: "/branchen/tischler" },
  { name: "SHK-Betrieb", desc: "Sanitär, Heizung, Klima", img: "/images/card-shk.avif", href: "/branchen/shk" },
